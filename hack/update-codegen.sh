...
bash "${CODEGEN_PKG}/generate-internal-groups.sh" deepcopy,conversion \
  github.com/Angus-F/metrics/pkg/client github.com/Angus-F/metrics/pkg/apis github.com/Angus-F/metrics/pkg/apis \
...
bash "${CODEGEN_PKG}/generate-groups.sh" client \
  github.com/Angus-F/metrics/pkg/client github.com/Angus-F/metrics/pkg/apis \
